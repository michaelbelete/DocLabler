...
export const documents: Document[] = [
	...
	{
		id: 1,
		title: 'Chinese Investment Bank CICC Plans Large Capital Raise to Bolster Business',
	...
	{
		id: 5,
		title: 'U.S. weighs China sanctions to deter Taiwan action, Taiwan presses EU',
